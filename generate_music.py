# Importing basic supporting libraries
import copy
import os
...
def gen_music_from_input(input_file, output_file):
    #load midi file
    loaded_sequence = mm.midi_file_to_note_sequence(input_dir)
    ...
    midi_io.note_sequence_to_midi_file(start_notes_at_0(h), output_file)

    print("Generate Done!🎉", " Output file saved to ", output_file)

'''
def main():
    #load midi file
    loaded_sequence = mm.midi_file_to_note_sequence(base+"/input_midi_dir/input.mid")
    ...
    midi_io.note_sequence_to_midi_file(start_notes_at_0(h), base+"/output_midi_dir/test.mid")
